...
var CCTST_1 = {
    ...
    timeline_variables: [
        { data: { i:1}, s: `
        <p style="font: 20pt 微软雅黑; text-align: left; width:900px; margin:0 auto;text-indent:-1.1em">
...
var CCTST_2_3_4 = {
    ...
    timeline_variables: [
        ...
        `<p style="font: 18pt 微软雅黑; text-align: left; width:900px; margin:0 auto;text-indent:-1.1em">
...
var CCTST_9_10_11_12_13_14_15 = {
    ...
    timeline_variables: [
        ...
        "<image src = '第9、10题.png' width=681 height=550 /><br/><br/>" +
        `<p style="font: 18pt 微软雅黑; text-align: left; width:900px; margin:0 auto;text-indent:-1.6em">
...
var CCTST_23_24_25_26_27_28_29_30 = {
    timeline: [{
        type: 'html-button-response',
        data: jsPsych.timelineVariable('data'),
        stimulus: jsPsych.timelineVariable('s'),
...
var CT_instruction = {
    type: 'survey-html-form',
    data: { varname: 'CT_instruction'},
    preamble: '您此前是否接受过批判性思维的相关教学？<br>', //棒！！可以修改为radio//选项左对齐
    html: `
    <p style="font: 18pt 宋体; text-align: left"> 
    <input name="Q0" type="radio" required="required"value="没有">没有<br>
    <input name="Q0" type="radio" required="required"value="非针对教学">有，但不是针对批判性思维的课程。<br>
    <input name="Q0" type="radio" required="required"value="针对性教学">有，是专为批判性思维教学开设的课程。</p>`,
    //要求必选
    button_label: '继续',
    on_finish: function(data) { addRespFromSurvey(data) }
};
...
var surveys = {
    timeline: [
        ...
        CCTST_5,
        CCTST_6_7_8,
        CCTST_9_10_11_12_13_14_15,
        CCTST_16_17,
        CCTST_18,
        CCTST_19_20,
        CCTST_21_22,
        CCTST_23_24_25_26_27_28_29_30,
        CCTST_31,
        CCTST_32_33_34,
    ]
}
